...
def logo():
	os.system("clear")
	print(f"{biru}Subscribe Channel {W}gwe dulu kak{biru} ! ! !{G}")
	os.system("xdg-open https://youtube.com/channel/UCMgvo7KsdZcuPXKXPrtr79w")
	time.sleep(10)
	os.system("clear")
	print (f"""{ungu}	|
{ungu}       ( )
...
{ungu}   .'|  |  |`. {W}[{Y}•{W}] Info Creator{R} :{W} tutur14l
{ungu}  (  |  |  |  )
{ungu}  |,-'--|--'-.|{R}   ({W} Version Script : 2.8 Decompile{R} )
{abu} ------------------------------------------------------
